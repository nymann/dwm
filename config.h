...
static Key keys[] = {
    ...
    { MODKEY,             XK_F3,                    spawn,          SHCMD("rofi -modi mymenu:bt-choose -show mymenu") },
    { MODKEY,             XK_F4,                    spawn,          SHCMD("rofi -modi mymenu:yt-audio-streams -show mymenu") },
    { MODKEY,             XK_F5,                    spawn,          SHCMD("bluetoothctl power off") },
    { MODKEY,             XK_F6,                    spawn,          SHCMD("pkill mpv") },
